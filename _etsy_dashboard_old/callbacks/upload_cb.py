...
from supabase_loader import append_etsy_transactions, append_bank_transactions
...
def register_callbacks(app):
    ...
    def upload_etsy_csv(contents, filename):
        ...
        # Sync to Supabase so data persists across restarts
        append_etsy_transactions(ds.DATA)
    ...
    def upload_bank_pdf(contents, filename):
        ...
        # Sync to Supabase so data persists across restarts
        append_bank_transactions(ds.BANK_TXNS)
        _notify_railway_reload()
