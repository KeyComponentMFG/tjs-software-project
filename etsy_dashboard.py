...
def _build_per_order_profit_section():
    ...
    if _ledger_orders:
        for _o in _ledger_orders:
            ...
            _table_data.append({
                ...
                "Buyer Ship": _o.get("Buyer Shipping", 0) if _o.get("Buyer Shipping", 0) > 0 else None,
                "Label": _o.get("Shipping Label", 0) if _o.get("Shipping Label", 0) > 0 else None,
                "Ship P/L": _o.get("Ship P/L", 0) if _o.get("Shipping Label", 0) > 0 else None,
    ...
    _dt_columns = [
        ...
        {"name": "Ship Paid", "id": "Buyer Ship", "type": "numeric", "format": {"specifier": "$,.2f"}},
    ...
    _order_table = dash_table.DataTable(
        ...
        style_cell_conditional=[
            ...
            {"if": {"column_id": "Buyer"}, "textAlign": "left", "width": "85px", "overflow": "hidden", "textOverflow": "ellipsis"},
            {"if": {"column_id": "Qty"}, "width": "28px", "textAlign": "center"},
            {"if": {"column_id": "Item"}, "textAlign": "left", "width": "170px",
             "overflow": "hidden", "textOverflow": "ellipsis", "maxWidth": "170px"},
            {"if": {"column_id": "Gross"}, "width": "58px", "color": GREEN},
            {"if": {"column_id": "Fees"}, "width": "48px", "color": RED},
            {"if": {"column_id": "Buyer Ship"}, "width": "55px", "color": TEAL},
            {"if": {"column_id": "Label"}, "width": "48px", "color": BLUE},
            {"if": {"column_id": "Ship P/L"}, "width": "55px"},
            {"if": {"column_id": "Ads"}, "width": "38px", "color": PURPLE},
            {"if": {"column_id": "True Net"}, "width": "62px", "color": CYAN, "fontWeight": "bold"},
        ...
        style_data_conditional=[
            ...
            {"if": {"filter_query": "{True Net} < 0", "column_id": "True Net"}, "color": RED, "fontWeight": "bold"},
            {"if": {"filter_query": "{True Net} >= 0", "column_id": "True Net"}, "color": CYAN, "fontWeight": "bold"},
